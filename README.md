...
A_Load_data_cv contains the function:
...
A_Classifiers_cv contains the functions: 
...
Gaussian contains code to check if the data follows a Gaussian distribution
